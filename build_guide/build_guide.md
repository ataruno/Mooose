...
部品"エンコーダ部分カバー"が左右反転状態で印刷されている可能性があります。  
その場合、組み立てると左手側のpromicroのはんだ付け足と干渉します。  
Boothのメッセージ機能にて正しいパーツの送付についてメッセージをお送りしています。  
またはX(Twitter)のダイレクトメッセージなどでご連絡いただけますでしょうか。  
